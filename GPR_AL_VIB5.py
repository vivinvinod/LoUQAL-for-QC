...
def var_main(mol='CH3Cl'):
    ...
    np.save(f'ModelData/var_VIB5_{mol}_relative_maes.npy',rel_mae)
...
def random_main(mol='CH3Cl'):
    ...
    np.save(f'ModelData/random_VIB5_{mol}_relative_maes.npy',rel_mae)
...
def MF_main(mol='CH3Cl',method='ccpvdz'):
    ...
    np.save(f'ModelData/mf_VIB5_{mol}_{method}_relative_maes.npy',rel_mae)
